...
Η παρούσα διπλωματική εργασία μελετά αλγορίθμους βέλτιστης επίλυσης του κύβου του Rubik 3×3×3 στη μετρική μισών στροφών (\eng{half-turn metric}, HTM), με τρεις στόχους: την υλοποίηση των αλγορίθμων Thistlethwaite, Kociemba και Korf, την αναγνώριση της απόστασης μιας κατάστασης από τη λυμένη θέση και την εύρεση κατάλληλης παραδεκτής ευρετικής συνάρτησης για βέλτιστη επίλυση με τον αλγόριθμο A* ή παραλλαγή του. Κεντρική αρχή της εργασίας είναι η διάκριση ανάμεσα στην εύρεση μιας έγκυρης λύσης και στην απόδειξη ότι η λύση είναι η συντομότερη δυνατή: κάθε αποτέλεσμα φέρει ρητή ετικέτα κατάστασης (\code{exact}, \code{non_exact}, \code{lower_bound}, \code{timeout}).

Ως μέθοδος, υλοποιούνται αναπαράσταση του κύβου σε επίπεδο κυβιδίων (\eng{cubies}), έλεγχος φυσικής εγκυρότητας, ανεξάρτητος επαληθευτής λύσεων, εξαντλητική αναζήτηση BFS για ρηχά βάθη και επιλύτης IDA* τύπου Korf, η επιλεγμένη παραλλαγή του A*, με παραδεκτή ευρετική από πίνακες προβολών (\eng{projection tables}), από εγγενώς παραγόμενο γωνιακό πίνακα προτύπων (\eng{pattern database}, PDB) και από οκτώ πίνακες προτύπων έξι ακμών. Για πρακτικές λύσεις γενικών καταστάσεων υλοποιούνται εγγενής οριοθετημένη (\eng{scoped}) διαδρομή δύο φάσεων Kociemba και εγγενής τετραφασική διαδρομή Thistlethwaite· οι λύσεις τους επαληθεύονται ανεξάρτητα αλλά δεν αποδεικνύονται βέλτιστες.

Ως αποτέλεσμα, ο εγγενής βέλτιστος επιλυτής αποδεικνύει ακριβείς αποστάσεις σε καταγεγραμμένες περιπτώσεις του σώματος μετρήσεων, ενώ παρουσιάζεται πλήρως εγγενής απόδειξη ότι η απόσταση του \eng{superflip} είναι ακριβώς 20: συμμετρικά ανηγμένος πίνακας \eng{FlipUDSlice} φάσης 1 με 16 συμμετρίες και παραδεκτό κάτω φράγμα τριών αξόνων κατά Reid αποκλείουν, με εξαντλητικό IDA* ενιαίου ορίου (\eng{single-bound}), κάθε λύση μήκους 19 ή μικρότερου. Η αναγνώριση απόστασης επιστρέφει ακριβή απόσταση μόνο με απόδειξη, διαφορετικά τεκμηριωμένο κάτω φράγμα, αποτέλεσμα εξάντλησης ορίων ή ένδειξη άκυρης κατάστασης. Για τεκμήρια ακριβούς αναζήτησης σε βαθύτερες περιπτώσεις, έως ονομαστικό βάθος 25, ενσωματώνεται με πλήρη απόδοση προέλευσης η διαδρομή H48 του δημόσιου επιλύτη \code{nissy-core}, η οποία δεν αποτελεί πρωτότυπη αλγοριθμική συνεισφορά της εργασίας και λειτουργεί και ως ανεξάρτητη διασταύρωση. Όλα τα πειράματα παράγονται από αναπαραγώγιμα σενάρια με σταθερό σπόρο τυχαιότητας (\eng{seed}) και αποθηκεύονται ως τεκμήρια πριν ενσωματωθούν στους πίνακες του κειμένου, ενώ η εργασία συμπληρώνεται από πλήρη εξαντλητική μελέτη του κύβου 2×2×2 (\eng{Pocket Cube}).

Η εργασία δεν αναπαράγει την απόδειξη του αριθμού του Θεού (\eng{God's number}) και δεν διατυπώνει εγγύηση πρακτικού χρόνου εκτέλεσης χείριστης περίπτωσης για κάθε αυθαίρετη κατάσταση 3×3×3· τα όρια κάθε ισχυρισμού δηλώνονται ρητά στα οικεία κεφάλαια.
