...
For command-line usage details, see `docs/cli_reference.md`. This document is
the canonical reproduction/runbook guide: it records the lightweight acceptance
gate, the full regeneration pipeline, source-state policy, and retained H48
table boundary.
