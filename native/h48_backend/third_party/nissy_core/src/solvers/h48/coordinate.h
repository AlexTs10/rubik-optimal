...
STATIC_INLINE uint64_t coord_h48_edges_rep(cube_t, uint64_t, uint8_t);
...
coord_h48_edges(cube_t c, uint64_t coclass, uint8_t ttrep, uint8_t h)
{
	...
	return coord_h48_edges_rep(d, coclass, h);
}

STATIC_INLINE uint64_t
coord_h48_edges_rep(cube_t d, uint64_t coclass, uint8_t h)
{
