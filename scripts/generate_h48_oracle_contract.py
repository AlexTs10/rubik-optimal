...
def write_table(root: Path, payload: dict[str, Any], suffix: str) -> Path:
    ...
    rows = [
        ...
        ("All-valid-state input support", payload["all_state_exact_contract_supported"]),
    ...
    label_gr = {
        "Fast optimal oracle API": "API γρήγορου oracle βελτιστότητας",
        "All-valid-state input support": "Υποστήριξη όλων των έγκυρων καταστάσεων ως εισόδου",
        "Empirical fast corpus": "Εμπειρικό γρήγορο σύνολο",
        "Every-state fast runtime proof": "Απόδειξη γρήγορου χρόνου για κάθε κατάσταση",
        "Fast API max seconds": "Μέγ. χρόνος fast API (s)",
        "Resident hard max seconds": "Μέγ. χρόνος resident αυστηρός (s)",
        "Resident speedup": "Επιτάχυνση resident",
        "Nissy optimal stress max seconds": "Μέγ. χρόνος Nissy optimal stress (s)",
        "Nissy-core direct max seconds": "Μέγ. χρόνος Nissy-core απευθείας (s)",
        "Portfolio Nissy-first max seconds": "Μέγ. χρόνος portfolio με Nissy πρώτα (s)",
        "Portfolio state recovery max seconds": "Μέγ. χρόνος portfolio ανάκτησης κατάστασης (s)",
        "Portfolio direct state max seconds": "Μέγ. χρόνος portfolio απευθείας κατάστασης (s)",
        "Race oracle max seconds": "Μέγ. χρόνος race oracle (s)",
        "Race direct state seconds": "Χρόνος race απευθείας κατάστασης (s)",
        "Resident race max seconds": "Μέγ. χρόνος resident race (s)",
        "Resident race direct seconds": "Χρόνος resident race απευθείας (s)",
        "Universal direct state seconds": "Χρόνος universal απευθείας κατάστασης (s)",
        "Universal H48 symmetry seconds": "Χρόνος universal H48 συμμετρίας (s)",
        "Universal H48 batch seconds": "Χρόνος universal H48 batch (s)",
        "Universal CLI max seconds": "Μέγ. χρόνος universal CLI (s)",
        "Universal CLI broader seconds": "Χρόνος universal CLI ευρύτερο (s)",
        "Universal CLI adaptive seconds": "Χρόνος universal CLI προσαρμοστικό (s)",
        "Universal CLI expanded seconds": "Χρόνος universal CLI διευρυμένο (s)",
        "Universal CLI live no-shortcuts seconds": "Χρόνος universal CLI live χωρίς συντομεύσεις (s)",
        "Universal CLI live no-shortcuts broader seconds": "Χρόνος universal CLI live χωρίς συντομεύσεις, ευρύτερο (s)",
        "Universal CLI known-distance 19 seconds": "Χρόνος universal CLI γνωστή απόσταση 19 (s)",
        "Universal CLI known-distance 20 seconds": "Χρόνος universal CLI γνωστή απόσταση 20 (s)",
        "Portfolio superflip fallback seconds": "Χρόνος portfolio εφεδρείας superflip (s)",
        "Portfolio superflip cache seconds": "Χρόνος portfolio cache superflip (s)",
        "Certificate symmetry cases": "Περιπτώσεις certificate συμμετρίας",
        "Expanded certificate symmetry cases": "Περιπτώσεις διευρυμένου certificate συμμετρίας",
        "Learned certificate replay seconds": "Χρόνος επανάληψης learned certificate (s)",
        "Live symmetry batch max seconds": "Μέγ. χρόνος live batch συμμετρίας (s)",
        "Nissy optimal table bytes": "Bytes πίνακα Nissy optimal",
        "h48h8 probe status": "Κατάσταση δοκιμής h48h8",
        "h48h8 probe allocated bytes": "Bytes που δεσμεύτηκαν στη δοκιμή h48h8",
        "h48h8 detached status": "Κατάσταση h48h8 detached",
        "h48h8 detached waits": "Αναμονές h48h8 detached",
    }

    def value_cell(value: object) -> str:
        if isinstance(value, bool):
            return "Ναι" if value else "Όχι"
        # status-token strings (timed_out, detached_process_...) stay verbatim;
        # _tex inserts \_\allowbreak{} so long tokens can break across the column.
        return _tex(value)
    ...
    for name, value in rows:
        body.append(f"{_tex(label_gr.get(name, name))} & {value_cell(value)} \\\\\n")
    body.extend(["\\hline\n", "\\end{tabular}\n", "}\n"])
